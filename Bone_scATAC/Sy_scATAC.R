...
#Filtering 871 cells from ArchRProject!
#        HAES1 : 597 of 7732 (7.7%)
#        HAS0416 : 0 of 6872 (0%)
#        OAS_0510 : 215 of 4645 (4.6%)
#        OAS_ZXG : 59 of 2442 (2.4%)
table(proj.filter@cellColData$Sample)#查看每个样本细胞数
#
#   HAES1  HAS0416 OAS_0510  OAS_ZXG 
#    7135     6872     4430     2383 
#####质控结果绘制
...
#                        6436                          182 
#Plasmacytoid dendritic cells               T and NK cells 
#                           1                          267 
...
#  C1  C10  C11  C12  C13  C14  C15  C16  C17  C18  C19  C20   C3   C4   C5   C6 
#   6 1417 1274  963   38    5    1  120  101  242  155 1100   48    4  477  292 
#  C7   C8   C9 
#1635  500 4496 
table(proj.filter_Fb@cellColData$Clusters_2)
#  C1  C10  C11  C12  C13  C14  C15  C16  C17  C18  C19   C2   C3   C4   C5   C6 
#   5  610 1762  909  890 1567  526  647  566  542  531    9  186  823  832  567 
#  C7   C8   C9 
# 480  334 1088
...
#HA_Fb1 HA_Fb1   1230        947           2  447  500   150000
#HA_Fb2 HA_Fb2   1431        907           2  407  500   150000
#HA_Fb3 HA_Fb3   1073        660           2  160  500   150000
#HA_Fb4 HA_Fb4   2700       1000           2  500  500   150000
#HA_Fb5 HA_Fb5    425        425           2   40  385   150000
#OA_Fb1 OA_Fb1   1559        947           2  447  500   150000
#OA_Fb2 OA_Fb2   1338        985           2  485  500   150000
#OA_Fb3 OA_Fb3    838        838           2  386  452   150000
#OA_Fb4 OA_Fb4   2174       1000           2  500  500   150000
#OA_Fb5 OA_Fb5    106        106           2   40   66    53000
...
# Fb1  Fb2  Fb3  Fb4  Fb5 
#2789 2769 1911 4874  531 
#
#HA_Fb1 HA_Fb2 HA_Fb3 HA_Fb4 HA_Fb5 OA_Fb1 OA_Fb2 OA_Fb3 OA_Fb4 OA_Fb5 
#  1230   1431   1073   2700    425   1559   1338    838   2174    106 
...
#Identified 412 markers!
# [1] "chr1:8396892-8397392"      "chr1:8873520-8874020"     
# [3] "chr1:19374852-19375352"    "chr1:19398305-19398805"   
# [5] "chr1:22375591-22376091"    "chr1:22388117-22388617"   
# [7] "chr1:32236031-32236531"    "chr1:33099230-33099730"   
# [9] "chr1:39927519-39928019"    "chr1:54850763-54851263"   
#[11] "chr1:55308975-55309475"    "chr1:67524589-67525089"   
#[13] "chr1:78223339-78223839"    "chr1:87594691-87595191"   
#[15] "chr1:91725933-91726433"    "chr1:147292835-147293335" 
#[17] "chr1:154431515-154432015"  "chr1:156477534-156478034" 
#[19] "chr1:161217014-161217514"  "chr1:118862682-118863182" 
#[21] "chr1:183198417-183198917"  "chr1:203663243-203663743" 
#[23] "chr1:205199374-205199874"  "chr1:222042082-222042582" 
#[25] "chr1:235011701-235012201"  "chr10:49138905-49139405"  
#[27] "chr10:114306573-114307073" "chr10:126243885-126244385"
#[29] "chr11:12076387-12076887"   "chr11:32034002-32034502"  
...
# [6] "ARNT2_76"    "ATF3_132"    "MAFA_146"    "ZFX_158"     "ZNF263_159" 
#[11] "KLF6_165"    "ZFY_166"     "MZF1_171"    "PATZ1_172"   "KLF5_175"   
#[16] "CTCF_177"    "MAZ_178"     "KLF1_179"    "SP4_180"     "KLF7_189"   
#[21] "EGR1_195"    "EGR2_196"    "CTCFL_198"   "RREB1_200"   "KLF16_205"  
#[26] "EGR4_207"    "KLF4_208"    "ZNF740_209"  "ZNF281_221"  "ZNF148_222" 
#[31] "KLF15_223"   "SP8_226"     "ZNF219_229"  "ZNF202_230"  "SP2_232"    
#[36] "SP7_241"     "ZNF524_243"  "SP3_247"     "INSM1_248"   "KLF14_251"  
#[41] "ZBTB7A_258"  "EGR3_259"    "ZBTB7C_265"  "WT1_266"     "SP1_267"    
#[46] "SP6_275"     "SP5_279"     "SP9_283"     "DNMT1_301"   "GRHL1_391"  
#[51] "TP63_704"    "TP73_705"    "EP300_804"   "PURA_813"    "KLF2_846"   
#[56] "KLF11_847"   "ZFP161_850"  "TFCP2L1_858" "SMAD5_866"  
...
p <- plotBrowserTrack(
    ...
    upstream = 150000,
    downstream = 100000,
    loops = getPeak2GeneLinks(projHeme5, corCutOff = 0.3,resolution = 1000,
    returnLoops = TRUE)
)
plotPDF(plotList = p, 
    name = "Plot-Tracks-Marker-Genes-with-CoAccessibility_2025.6.5_SY.pdf", 
    ArchRProj = projHeme5, 
...
p <- plotBrowserTrack(
    ...
    upstream = 100000,
    downstream = 100000,
    loops = getPeak2GeneLinks(projHeme5, corCutOff = 0.25,resolution = 1000,
    returnLoops = TRUE)
)
plotPDF(plotList = p, 
    name = "Plot-Tracks-Marker-Genes-with-CoAccessibility_2025.6.5_SY.pdf", 
...
plotPDF(plotList = p, 
    name = "Plot-Tracks-Marker-Genes-with-Peak2GeneLinks_2025.6.7.pdf", 
    ArchRProj = projHeme5, 
...
p <- plotBrowserTrack(
    ArchRProj = projHeme5, 
    groupBy = "group", 
    geneSymbol =  c("SMARCC1"), 
    upstream = 120000,
    downstream = 100000,
    loops = getPeak2GeneLinks(projHeme5, corCutOff = 0.3,resolution = 100,returnLoops = TRUE)
)
plotPDF(plotList = p, 
    name = "Plot-Tracks-Marker-Genes-with-Peak2GeneLinks_2025.6.7_SMARCC1.pdf", 
    ArchRProj = projHeme5, 
    addDOC = FALSE, width = 15, height = 8)
...
plotPDF(plotList = p, 
    name = "Plot-Tracks-Marker-Genes-with-CoAccessibility_2025.8.18.3.ANGPTL4.pdf", 
    ArchRProj = projHeme5, 
    addDOC = FALSE, width = 15, height = 8)
...
plotPDF(plotList = p, 
    name = "Plot-Tracks-Marker-Genes-with-Peak2GeneLinks_2025.8.18.2.ANGPTL4.pdf", 
    ArchRProj = projHeme5, 
    addDOC = FALSE, width = 15, height = 8)
...
coverageFiles1 <- getGroupBW(ArchRProj = projHeme5, groupBy = "Sample")
