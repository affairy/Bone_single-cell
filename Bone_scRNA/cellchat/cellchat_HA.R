...
# 提取 HA_Sy_Mo 的表达矩阵和元数据
mat_mo <- GetAssayData(HA_Sy_Mo, assay = "origin.counts", slot = "counts")
meta_mo <- HA_Sy_Mo@meta.data

# 提取 HA_Sy_Fb 的表达矩阵和元数据
mat_fb <- GetAssayData(HA_Sy_Fb, assay = "origin.counts", slot = "counts")
meta_fb <- HA_Sy_Fb@meta.data
...
groupSize
# [1] 1656 1367 1128  529  211   85 5008 2796 1493 5309 2131 1634  709 4152 1121
#[16] 3268 1871 1269 3678 2493  990
...
#         Mo_HA1_AGGACTCACCCATAATCGAACAAGTGG Mo_HA1_TGCCTGATCCGATAAGGCAACAAGTGG # nolint
#TNFRSF18                        0.000000000                        0.000000000
#TNFRSF4                         0.000000000                        0.000000000
#TNFRSF14                        0.004637861                        0.001786143
#TNFRSF25                        0.000000000                        0.000000000
#         Mo_HA1_TCTGGCGAATAGTCCGGAAACAAGTGG Mo_HA1_TCGGTTCGTTCTTCTCAGAACAAGTGG
#TNFRSF18                        0.000000000                        0.000000000
#TNFRSF4                         0.000000000                        0.000000000
#TNFRSF14                        0.001687945                        0.004107527
#TNFRSF25                        0.000000000                        0.000000000
# 检查 CellChat 对象中的因子水平
levels(cellchat@idents)
...
ggsave("Mye_Lymph_bubble_Ch1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Ch3.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
# save as TIL/Mye_Lymph_bubble.pdf
...
ggsave("Mye_Lymph_bubble_Ch2.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Ch6.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Ch7.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Ch5.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Ch4.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Ch8.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_SC_M1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_SC_M2.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_SC_M3.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_SC_M4.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_SC_M5.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_SC_M6.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Fb1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Fb2.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Fb3.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Fb4.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Fb5.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Fb6.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Fb7.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Ch1.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Ch3.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Ch2.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Ch6.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Ch7.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Ch5.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Ch4.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Ch8.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_SC_M1.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_SC_M2.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_SC_M3.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_SC_M4.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_SC_M5.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_SC_M6.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Fb1.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Fb2.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Fb3.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Fb4.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Fb5.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Fb6.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
...
ggsave("Mye_Lymph_bubble_Fb7.1.pdf", p, width = 10, height = 30) #髓系对淋巴的调节
